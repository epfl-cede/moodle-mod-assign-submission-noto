...
/**
 * This file contains the moodle hooks for the submission noto plugin
 *
 ...
 */
function assignsubmission_noto_pluginfile($course,
                                                $cm,
                                                context $context,
                                                $filearea,
                                                $args,
    ...
    $fullpath = "/{$context->id}/assignsubmission_noto/$filearea/$itemid/$relativepath";
