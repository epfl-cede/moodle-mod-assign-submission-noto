...
/**
 * The assignsubmission_noto submission_updated event.
 *
...
/**
 * The assignsubmission_noto submission_updated event class.
 */
class submission_updated extends \mod_assign\event\submission_updated {
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' created a remote copy of a Jupiter Notebook in '{$this->other['directory']}' for course module id " . "'$this->contextinstanceid'";
