...
/* Automatic grading */
$string['automaticgradingsettings'] = 'Automatic grading settings';
$string['automaticgrading_url'] = 'Automatic grading URL';
$string['automaticgrading_url_help'] = '';
$string['automaticgrading_token_send'] = 'Token for sending submissions to the grading service';
$string['automaticgrading_token_send_help'] = '';
$string['automaticgrading_token_receive'] = 'Token for receiving grading results';
$string['automaticgrading_token_receive_help'] = '';
$string['automaticgrading_job_timeout'] = 'Timeout for grading jobs to return results';
$string['automaticgrading_job_timeout_help'] = 'in seconds';
$string['automaticgrading_gradingattempt_retries'] = 'Maximum retries for grading attempts';
$string['automaticgrading_gradingattempt_retries_help'] = '';
$string['automaticgrading_noatutorized'] = 'You are not authorized for this action';
$string['cannotcreateautogradedir'] = 'Cannot create autograde temp dir. Autograding will be disabled in this assignment';
$string['cannotreadsidzip'] = 'Cannot open sid zip. Autograding will be disabled in this assignment';
$string['cannotextractautograde'] = 'Cannot extract autograde files. Autograding will be disabled in this assignment';
$string['cannotcreateaza'] = 'Cannot create new autograde archive. Autograding will be disabled in this assignment';
$string['cannotaddautogradeinfile'] = 'Cannot add one of internal autograde files';
$string['cannotreadautogradeinfile'] = 'Cannot read one of internal autograde files';
$string['cannotcloseaza'] = 'Cannot close new autograde archive. Autograding will be disabled in this assignment';
$string['cannotfindfinalaza'] = 'Cannot form new autograde archive. Autograding will be disabled in this assignment';
$string['autograding_enabled'] = 'Autograding is <strong>enabled</strong>';
$string['autograding_suspended'] = 'Autograding is <strong>suspended</strong>';
$string['disable'] = 'Disable';
$string['suspend'] = 'Suspend';
$string['unsuspend'] = 'Unsuspend';
$string['autograding_disabled'] = 'Autograding is <strong>disabled</strong>';
$string['disableautogradingconfirmation'] = 'Are you sure you want to completely disable autograding in this assignment? This will be impossible to undo.';
$string['notgraded'] = 'Not graded';
$string['pending'] = 'Pending';
$string['graded'] = 'Graded';
$string['gradingtimeout'] = 'Grading timed out';
$string['gradingfailed'] = 'Grading failed';
$string['autograde_status'] = 'Grading status: <strong>{$a}</strong>';
$string['unspecified_error'] = 'Unspecified error';
$string['retry_autograde'] = 'Re-send submissions for autograding';
$string['autogradepdf'] = 'View autograde PDF';
$string['autogradejson'] = 'View autograde JSON';
$string[''] = '';
